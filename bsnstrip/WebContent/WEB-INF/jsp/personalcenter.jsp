						...
						<div class="ibox-content">
							<form class="form-horizontal m-t" id="editForm" name="editForm">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<span class="form-control" style="border: 0px;" id="role"></span>
									</div>
								</div>
			...
			$("#editForm").validate({
				...
				submitHandler : function(form) {
						...
						console.log(loginFormData);   //user_name=admin&user_pwd=abc
						  ...
						  $.post(getContextPath()+ "/user/editMyData.do",loginFormData,
							function(resObj) {
								//console.log(resObj)
								if (resObj == "true") {
									swal({
										...
										window.location.href = getContextPath()+ "/user/toPersonalCenter.do"
									});
								} else {
									swal({
										title: "操作失败",
