...
public class JieKuanDan {
	
	public static String getTable(HttpServletRequest request, TLoan loan, TEmployee employee) {
		...
		String applyDate = format.format(loan.getApplydate());
        ...
        try 
        {
            ...
            PdfPCell cell11 = new PdfPCell(new Paragraph("出差借款单",FontChinese24));
            ...
            PdfPCell cell21 = new PdfPCell(new Paragraph("借款概要",FontChinese16));
            ...
            PdfPCell cell321 = new PdfPCell(new Paragraph(loan.getUserid().toString(), FontChinese11Normal));
...
//            cell331.setVerticalAlignment(Element.ALIGN_LEFT);
            ...
            PdfPCell cell42 = new PdfPCell(new Paragraph("借款金额：",FontChinese11Bold));
            PdfPCell cell421 = new PdfPCell(new Paragraph(NumberToCN.number2CNMontrayUnit(new BigDecimal(loan.getLoanfee())),FontChinese11Normal));
            cell42.setBorder(0);
            cell421.setBorder(0);
          ...
          //加入空行
            ...
            PdfPCell cell51 = new PdfPCell(new Paragraph("借款说明：",FontChinese11Bold));
            PdfPCell cell511 = new PdfPCell(new Paragraph(loan.getLoancontent(),FontChinese11Normal));
            cell511.setBorder(0);
            cell51.setBorder(0);
...
//            PdfPCell cell94 = new PdfPCell(new Paragraph("申请人签名：",FontChinese11Bold));
